<?php
/**
 * APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.A_HandlingUnitHeaderDeliveryType-update';
    ...
    */
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setHandlingUnitBaseUnitOfMeasure($handling_unit_base_unit_of_measure)
    {
        ...
        if ((mb_strlen($handling_unit_base_unit_of_measure) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_base_unit_of_measure when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitContentDescription($handling_unit_content_description)
    {
        ...
        if ((mb_strlen($handling_unit_content_description) > 40)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_content_description when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setHandlingUnitExternalId($handling_unit_external_id)
    {
        ...
        if ((mb_strlen($handling_unit_external_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_external_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setHandlingUnitSecondExternalId($handling_unit_second_external_id)
    {
        ...
        if ((mb_strlen($handling_unit_second_external_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_second_external_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setHandlingUnitTareVolumeUnit($handling_unit_tare_volume_unit)
    {
        ...
        if ((mb_strlen($handling_unit_tare_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_tare_volume_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitTareWeightUnit($handling_unit_tare_weight_unit)
    {
        ...
        if ((mb_strlen($handling_unit_tare_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_tare_weight_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitUoMDimension($handling_unit_uo_m_dimension)
    {
        ...
        if ((mb_strlen($handling_unit_uo_m_dimension) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_uo_m_dimension when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPackagingMaterial($packaging_material)
    {
        ...
        if ((mb_strlen($packaging_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $packaging_material when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setVolumeUnit($volume_unit)
    {
        ...
        if ((mb_strlen($volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $volume_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setWeightUnit($weight_unit)
    {
        ...
        if ((mb_strlen($weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $weight_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryTypeUpdate., must be smaller than or equal to 3.');
        }
