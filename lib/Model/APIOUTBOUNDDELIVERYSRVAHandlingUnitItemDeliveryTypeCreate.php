<?php
/**
 * APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.A_HandlingUnitItemDeliveryType-create';
    ...
    */
    ...
    public function setBatch($batch)
    {
        ...
        if ((mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryDocumentItem($delivery_document_item)
    {
        ...
        if ((mb_strlen($delivery_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_item when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setHandlingUnitExternalId($handling_unit_external_id)
    {
        ...
        if ((mb_strlen($handling_unit_external_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_external_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setHandlingUnitInternalId($handling_unit_internal_id)
    {
        ...
        if ((mb_strlen($handling_unit_internal_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_internal_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setHandlingUnitNestedInternalId($handling_unit_nested_internal_id)
    {
        ...
        if ((mb_strlen($handling_unit_nested_internal_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_nested_internal_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setHandlingUnitQuantityUnit($handling_unit_quantity_unit)
    {
        ...
        if ((mb_strlen($handling_unit_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_quantity_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitTypeOfContent($handling_unit_type_of_content)
    {
        ...
        if ((mb_strlen($handling_unit_type_of_content) > 1)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_type_of_content when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setMaterial($material)
    {
        ...
        if ((mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitItemDeliveryTypeCreate., must be smaller than or equal to 40.');
        }
