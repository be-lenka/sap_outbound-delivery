...
/**
 * APIOUTBOUNDDELIVERYSRVAMaintenanceItemObjectTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVAMaintenanceItemObjectTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.A_MaintenanceItemObjectType-create';
    ...
    */
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling APIOUTBOUNDDELIVERYSRVAMaintenanceItemObjectTypeCreate., must be smaller than or equal to 18.');
        }
