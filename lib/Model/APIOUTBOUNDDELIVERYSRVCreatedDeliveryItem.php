<?php
/**
 * APIOUTBOUNDDELIVERYSRVCreatedDeliveryItem
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIOUTBOUNDDELIVERYSRVCreatedDeliveryItem Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVCreatedDeliveryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.CreatedDeliveryItem';
    ...
    */
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APIOUTBOUNDDELIVERYSRVCreatedDeliveryItem., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryDocumentItem($delivery_document_item)
    {
        ...
        if ((mb_strlen($delivery_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_item when calling APIOUTBOUNDDELIVERYSRVCreatedDeliveryItem., must be smaller than or equal to 6.');
        }
