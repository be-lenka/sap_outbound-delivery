<?php
/**
 * APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.A_OutbDeliveryHeaderType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_delivery_document_text' => '\BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentText',
        'to_handling_unit_header_delivery' => '\BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToHandlingUnitHeaderDelivery',
        'to_delivery_document_partner' => '\BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentPartner',
        'to_delivery_document_item' => '\BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentItem'
    ];
    ...
    */
    ...
    public function setBillOfLading($bill_of_lading)
    {
        ...
        if (!is_null($bill_of_lading) && (mb_strlen($bill_of_lading) > 35)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_lading when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDocumentBySupplier($delivery_document_by_supplier)
    {
        ...
        if (!is_null($delivery_document_by_supplier) && (mb_strlen($delivery_document_by_supplier) > 35)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_by_supplier when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderVolumeUnit($header_volume_unit)
    {
        ...
        if (!is_null($header_volume_unit) && (mb_strlen($header_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_volume_unit when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setHeaderWeightUnit($header_weight_unit)
    {
        ...
        if (!is_null($header_weight_unit) && (mb_strlen($header_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_weight_unit when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 28.');
        }
    ...
    public function setMeansOfTransport($means_of_transport)
    {
        ...
        if (!is_null($means_of_transport) && (mb_strlen($means_of_transport) > 20)) {
            throw new \InvalidArgumentException('invalid length for $means_of_transport when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 20.');
        }
    ...
    public function setMeansOfTransportType($means_of_transport_type)
    {
        ...
        if (!is_null($means_of_transport_type) && (mb_strlen($means_of_transport_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $means_of_transport_type when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProposedDeliveryRoute($proposed_delivery_route)
    {
        ...
        if (!is_null($proposed_delivery_route) && (mb_strlen($proposed_delivery_route) > 6)) {
            throw new \InvalidArgumentException('invalid length for $proposed_delivery_route when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if (!is_null($unloading_point_name) && (mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreate., must be smaller than or equal to 25.');
        }
     ...
     *
     * @return \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentText|null
     */
     ...
     *
     * @param \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentText|null $to_delivery_document_text to_delivery_document_text
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToHandlingUnitHeaderDelivery|null
     */
     ...
     *
     * @param \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToHandlingUnitHeaderDelivery|null $to_handling_unit_header_delivery to_handling_unit_header_delivery
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentPartner|null
     */
     ...
     *
     * @param \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentPartner|null $to_delivery_document_partner to_delivery_document_partner
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentItem|null
     */
     ...
     *
     * @param \BeLenka\SAP\OutboundDelivery\Model\APIOUTBOUNDDELIVERYSRVAOutbDeliveryHeaderTypeCreateToDeliveryDocumentItem|null $to_delivery_document_item to_delivery_document_item
     *
     * @return self
     */
