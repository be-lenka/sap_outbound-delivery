...
/**
 * APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.A_HandlingUnitHeaderDeliveryType';
    ...
    protected static $openAPITypes = [
        ...
        'handling_unit_external_id_type' => 'string',
        'handling_unit_height' => 'float',
        'handling_unit_internal_id' => 'string',
        'handling_unit_internal_status' => 'string',
        'handling_unit_length' => 'float',
        'handling_unit_lower_level_refer' => 'string',
        ...
        'packaging_material_category' => 'string',
        'packaging_material_group' => 'string',
        'packaging_material_type' => 'string',
        'packing_instruction_number' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'handling_unit_external_id_type' => null,
        'handling_unit_height' => 'decimal',
        'handling_unit_internal_id' => null,
        'handling_unit_internal_status' => null,
        'handling_unit_length' => 'decimal',
        'handling_unit_lower_level_refer' => null,
        ...
        'packaging_material_category' => null,
        'packaging_material_group' => null,
        'packaging_material_type' => null,
        'packing_instruction_number' => null,
        'shipping_point' => null,
        'volume_unit' => null,
        'weight_unit' => null,
    ...
    protected static array $openAPINullables = [
		...
		'handling_unit_external_id_type' => false,
		'handling_unit_height' => false,
		'handling_unit_internal_id' => false,
		'handling_unit_internal_status' => false,
		'handling_unit_length' => false,
		'handling_unit_lower_level_refer' => false,
		...
		'packaging_material_category' => false,
		'packaging_material_group' => false,
		'packaging_material_type' => false,
		'packing_instruction_number' => false,
    ...
    protected static $attributeMap = [
        ...
        'handling_unit_external_id_type' => 'HandlingUnitExternalIdType',
        'handling_unit_height' => 'HandlingUnitHeight',
        'handling_unit_internal_id' => 'HandlingUnitInternalId',
        'handling_unit_internal_status' => 'HandlingUnitInternalStatus',
        'handling_unit_length' => 'HandlingUnitLength',
        'handling_unit_lower_level_refer' => 'HandlingUnitLowerLevelRefer',
        ...
        'packaging_material_category' => 'PackagingMaterialCategory',
        'packaging_material_group' => 'PackagingMaterialGroup',
        'packaging_material_type' => 'PackagingMaterialType',
        'packing_instruction_number' => 'PackingInstructionNumber',
    ...
    protected static $setters = [
        ...
        'handling_unit_external_id_type' => 'setHandlingUnitExternalIdType',
        'handling_unit_height' => 'setHandlingUnitHeight',
        'handling_unit_internal_id' => 'setHandlingUnitInternalId',
        'handling_unit_internal_status' => 'setHandlingUnitInternalStatus',
        'handling_unit_length' => 'setHandlingUnitLength',
        'handling_unit_lower_level_refer' => 'setHandlingUnitLowerLevelRefer',
        ...
        'packaging_material_category' => 'setPackagingMaterialCategory',
        'packaging_material_group' => 'setPackagingMaterialGroup',
        'packaging_material_type' => 'setPackagingMaterialType',
        'packing_instruction_number' => 'setPackingInstructionNumber',
    ...
    protected static $getters = [
        ...
        'handling_unit_external_id_type' => 'getHandlingUnitExternalIdType',
        'handling_unit_height' => 'getHandlingUnitHeight',
        'handling_unit_internal_id' => 'getHandlingUnitInternalId',
        'handling_unit_internal_status' => 'getHandlingUnitInternalStatus',
        'handling_unit_length' => 'getHandlingUnitLength',
        'handling_unit_lower_level_refer' => 'getHandlingUnitLowerLevelRefer',
        ...
        'packaging_material_category' => 'getPackagingMaterialCategory',
        'packaging_material_group' => 'getPackagingMaterialGroup',
        'packaging_material_type' => 'getPackagingMaterialType',
        'packing_instruction_number' => 'getPackingInstructionNumber',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('handling_unit_external_id_type', $data ?? [], null);
        $this->setIfExists('handling_unit_height', $data ?? [], null);
        $this->setIfExists('handling_unit_internal_id', $data ?? [], null);
        $this->setIfExists('handling_unit_internal_status', $data ?? [], null);
        $this->setIfExists('handling_unit_length', $data ?? [], null);
        $this->setIfExists('handling_unit_lower_level_refer', $data ?? [], null);
        ...
        $this->setIfExists('packaging_material_category', $data ?? [], null);
        $this->setIfExists('packaging_material_group', $data ?? [], null);
        $this->setIfExists('packaging_material_type', $data ?? [], null);
        $this->setIfExists('packing_instruction_number', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['handling_unit_external_id_type']) && (mb_strlen($this->container['handling_unit_external_id_type']) > 1)) {
            $invalidProperties[] = "invalid value for 'handling_unit_external_id_type', the character length must be smaller than or equal to 1.";
        }
        ...
        if (!is_null($this->container['handling_unit_internal_status']) && (mb_strlen($this->container['handling_unit_internal_status']) > 4)) {
            $invalidProperties[] = "invalid value for 'handling_unit_internal_status', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['handling_unit_lower_level_refer']) && (mb_strlen($this->container['handling_unit_lower_level_refer']) > 10)) {
            $invalidProperties[] = "invalid value for 'handling_unit_lower_level_refer', the character length must be smaller than or equal to 10.";
        }
        ...
        if (!is_null($this->container['packaging_material_category']) && (mb_strlen($this->container['packaging_material_category']) > 1)) {
            $invalidProperties[] = "invalid value for 'packaging_material_category', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['packaging_material_group']) && (mb_strlen($this->container['packaging_material_group']) > 4)) {
            $invalidProperties[] = "invalid value for 'packaging_material_group', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['packaging_material_type']) && (mb_strlen($this->container['packaging_material_type']) > 4)) {
            $invalidProperties[] = "invalid value for 'packaging_material_type', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['packing_instruction_number']) && (mb_strlen($this->container['packing_instruction_number']) > 20)) {
            $invalidProperties[] = "invalid value for 'packing_instruction_number', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setCreatedByUser($created_by_user)
    {
        ...
        if ((mb_strlen($created_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $created_by_user when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 12.');
        }
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 10.');
        }
    ...
    public function setHandlingUnitBaseUnitOfMeasure($handling_unit_base_unit_of_measure)
    {
        ...
        if ((mb_strlen($handling_unit_base_unit_of_measure) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_base_unit_of_measure when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitContentDescription($handling_unit_content_description)
    {
        ...
        if ((mb_strlen($handling_unit_content_description) > 40)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_content_description when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 40.');
        }
    ...
    public function setHandlingUnitExternalId($handling_unit_external_id)
    {
        ...
        if ((mb_strlen($handling_unit_external_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_external_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 20.');
        }
    ...
    /**
     * Gets handling_unit_external_id_type
     *
     * @return string|null
     */
    public function getHandlingUnitExternalIdType()
    {
        return $this->container['handling_unit_external_id_type'];
    }

    /**
     * Sets handling_unit_external_id_type
     *
     * @param string|null $handling_unit_external_id_type handling_unit_external_id_type
     *
     * @return self
     */
    public function setHandlingUnitExternalIdType($handling_unit_external_id_type)
    {
        if (is_null($handling_unit_external_id_type)) {
            throw new \InvalidArgumentException('non-nullable handling_unit_external_id_type cannot be null');
        }
        if ((mb_strlen($handling_unit_external_id_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_external_id_type when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 1.');
        }

        $this->container['handling_unit_external_id_type'] = $handling_unit_external_id_type;
    ...
    public function setHandlingUnitInternalId($handling_unit_internal_id)
    {
        ...
        if ((mb_strlen($handling_unit_internal_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_internal_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets handling_unit_internal_status
     *
     * @return string|null
     */
    public function getHandlingUnitInternalStatus()
    {
        return $this->container['handling_unit_internal_status'];
    }

    /**
     * Sets handling_unit_internal_status
     *
     * @param string|null $handling_unit_internal_status handling_unit_internal_status
     *
     * @return self
     */
    public function setHandlingUnitInternalStatus($handling_unit_internal_status)
    {
        if (is_null($handling_unit_internal_status)) {
            throw new \InvalidArgumentException('non-nullable handling_unit_internal_status cannot be null');
        }
        if ((mb_strlen($handling_unit_internal_status) > 4)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_internal_status when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 4.');
        }

        $this->container['handling_unit_internal_status'] = $handling_unit_internal_status;
    ...
    /**
     * Gets handling_unit_lower_level_refer
     *
     * @return string|null
     */
    public function getHandlingUnitLowerLevelRefer()
    {
        return $this->container['handling_unit_lower_level_refer'];
    }

    /**
     * Sets handling_unit_lower_level_refer
     *
     * @param string|null $handling_unit_lower_level_refer handling_unit_lower_level_refer
     *
     * @return self
     */
    public function setHandlingUnitLowerLevelRefer($handling_unit_lower_level_refer)
    {
        if (is_null($handling_unit_lower_level_refer)) {
            throw new \InvalidArgumentException('non-nullable handling_unit_lower_level_refer cannot be null');
        }
        if ((mb_strlen($handling_unit_lower_level_refer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_lower_level_refer when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 10.');
        }

        $this->container['handling_unit_lower_level_refer'] = $handling_unit_lower_level_refer;
    ...
    public function setHandlingUnitSecondExternalId($handling_unit_second_external_id)
    {
        ...
        if ((mb_strlen($handling_unit_second_external_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_second_external_id when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 20.');
        }
    ...
    public function setHandlingUnitTareVolumeUnit($handling_unit_tare_volume_unit)
    {
        ...
        if ((mb_strlen($handling_unit_tare_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_tare_volume_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitTareWeightUnit($handling_unit_tare_weight_unit)
    {
        ...
        if ((mb_strlen($handling_unit_tare_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_tare_weight_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 3.');
        }
    ...
    public function setHandlingUnitUoMDimension($handling_unit_uo_m_dimension)
    {
        ...
        if ((mb_strlen($handling_unit_uo_m_dimension) > 3)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_uo_m_dimension when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 3.');
        }
    ...
    public function setLastChangedByUser($last_changed_by_user)
    {
        ...
        if (!is_null($last_changed_by_user) && (mb_strlen($last_changed_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $last_changed_by_user when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 12.');
        }
     ...
     *
     * @param string|null $last_change_time last_change_time
     *
     * @return self
     */
    ...
    public function setPackagingMaterial($packaging_material)
    {
        ...
        if ((mb_strlen($packaging_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $packaging_material when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 40.');
        }
    ...
    /**
     * Gets packaging_material_category
     *
     * @return string|null
     */
    public function getPackagingMaterialCategory()
    {
        return $this->container['packaging_material_category'];
    }

    /**
     * Sets packaging_material_category
     *
     * @param string|null $packaging_material_category packaging_material_category
     *
     * @return self
     */
    public function setPackagingMaterialCategory($packaging_material_category)
    {
        if (is_null($packaging_material_category)) {
            throw new \InvalidArgumentException('non-nullable packaging_material_category cannot be null');
        }
        if ((mb_strlen($packaging_material_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $packaging_material_category when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 1.');
        }

        $this->container['packaging_material_category'] = $packaging_material_category;

        return $this;
    }

    /**
     * Gets packaging_material_group
     *
     * @return string|null
     */
    public function getPackagingMaterialGroup()
    {
        return $this->container['packaging_material_group'];
    }

    /**
     * Sets packaging_material_group
     *
     * @param string|null $packaging_material_group packaging_material_group
     *
     * @return self
     */
    public function setPackagingMaterialGroup($packaging_material_group)
    {
        if (is_null($packaging_material_group)) {
            throw new \InvalidArgumentException('non-nullable packaging_material_group cannot be null');
        }
        if ((mb_strlen($packaging_material_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $packaging_material_group when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 4.');
        }

        $this->container['packaging_material_group'] = $packaging_material_group;

        return $this;
    }

    /**
     * Gets packaging_material_type
     *
     * @return string|null
     */
    public function getPackagingMaterialType()
    {
        return $this->container['packaging_material_type'];
    }

    /**
     * Sets packaging_material_type
     *
     * @param string|null $packaging_material_type packaging_material_type
     *
     * @return self
     */
    public function setPackagingMaterialType($packaging_material_type)
    {
        if (is_null($packaging_material_type)) {
            throw new \InvalidArgumentException('non-nullable packaging_material_type cannot be null');
        }
        if ((mb_strlen($packaging_material_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $packaging_material_type when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 4.');
        }

        $this->container['packaging_material_type'] = $packaging_material_type;

        return $this;
    }

    /**
     * Gets packing_instruction_number
     *
     * @return string|null
     */
    public function getPackingInstructionNumber()
    {
        return $this->container['packing_instruction_number'];
    }

    /**
     * Sets packing_instruction_number
     *
     * @param string|null $packing_instruction_number packing_instruction_number
     *
     * @return self
     */
    public function setPackingInstructionNumber($packing_instruction_number)
    {
        if (is_null($packing_instruction_number)) {
            throw new \InvalidArgumentException('non-nullable packing_instruction_number cannot be null');
        }
        if ((mb_strlen($packing_instruction_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $packing_instruction_number when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 20.');
        }

        $this->container['packing_instruction_number'] = $packing_instruction_number;
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if ((mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 4.');
        }
    ...
    public function setVolumeUnit($volume_unit)
    {
        ...
        if ((mb_strlen($volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $volume_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 3.');
        }
    ...
    public function setWeightUnit($weight_unit)
    {
        ...
        if ((mb_strlen($weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $weight_unit when calling APIOUTBOUNDDELIVERYSRVAHandlingUnitHeaderDeliveryType., must be smaller than or equal to 3.');
        }
