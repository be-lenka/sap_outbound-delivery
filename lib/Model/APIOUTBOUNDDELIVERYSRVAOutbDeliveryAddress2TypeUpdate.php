<?php
/**
 * APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_OUTBOUND_DELIVERY_SRV.A_OutbDeliveryAddress2Type-update';
    ...
    */
    ...
    public function setAdditionalStreetPrefixName($additional_street_prefix_name)
    {
        ...
        if (!is_null($additional_street_prefix_name) && (mb_strlen($additional_street_prefix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_street_prefix_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setAdditionalStreetSuffixName($additional_street_suffix_name)
    {
        ...
        if (!is_null($additional_street_suffix_name) && (mb_strlen($additional_street_suffix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_street_suffix_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setAddressTimeZone($address_time_zone)
    {
        ...
        if ((mb_strlen($address_time_zone) > 6)) {
            throw new \InvalidArgumentException('invalid length for $address_time_zone when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setBuilding($building)
    {
        ...
        if (!is_null($building) && (mb_strlen($building) > 20)) {
            throw new \InvalidArgumentException('invalid length for $building when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setBusinessPartnerName1($business_partner_name1)
    {
        ...
        if ((mb_strlen($business_partner_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name1 when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName2($business_partner_name2)
    {
        ...
        if (!is_null($business_partner_name2) && (mb_strlen($business_partner_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name2 when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName3($business_partner_name3)
    {
        ...
        if (!is_null($business_partner_name3) && (mb_strlen($business_partner_name3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name3 when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName4($business_partner_name4)
    {
        ...
        if (!is_null($business_partner_name4) && (mb_strlen($business_partner_name4) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name4 when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCareOfName($care_of_name)
    {
        ...
        if (!is_null($care_of_name) && (mb_strlen($care_of_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $care_of_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if ((mb_strlen($city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setCompanyPostalCode($company_postal_code)
    {
        ...
        if (!is_null($company_postal_code) && (mb_strlen($company_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $company_postal_code when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setCorrespondenceLanguage($correspondence_language)
    {
        ...
        if (!is_null($correspondence_language) && (mb_strlen($correspondence_language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $correspondence_language when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 40)) {
            throw new \InvalidArgumentException('invalid length for $county when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if (!is_null($district) && (mb_strlen($district) > 40)) {
            throw new \InvalidArgumentException('invalid length for $district when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 241)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 241.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if (!is_null($fax_number) && (mb_strlen($fax_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setFaxNumberExtension($fax_number_extension)
    {
        ...
        if (!is_null($fax_number_extension) && (mb_strlen($fax_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fax_number_extension when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setFloor($floor)
    {
        ...
        if (!is_null($floor) && (mb_strlen($floor) > 10)) {
            throw new \InvalidArgumentException('invalid length for $floor when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setHomeCityName($home_city_name)
    {
        ...
        if (!is_null($home_city_name) && (mb_strlen($home_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $home_city_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if (!is_null($house_number) && (mb_strlen($house_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setHouseNumberSupplementText($house_number_supplement_text)
    {
        ...
        if (!is_null($house_number_supplement_text) && (mb_strlen($house_number_supplement_text) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number_supplement_text when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setMobilePhoneNumber($mobile_phone_number)
    {
        ...
        if (!is_null($mobile_phone_number) && (mb_strlen($mobile_phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone_number when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setPhoneNumberExtension($phone_number_extension)
    {
        ...
        if (!is_null($phone_number_extension) && (mb_strlen($phone_number_extension) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_extension when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBox($po_box)
    {
        ...
        if (!is_null($po_box) && (mb_strlen($po_box) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBoxDeviatingCityName($po_box_deviating_city_name)
    {
        ...
        if (!is_null($po_box_deviating_city_name) && (mb_strlen($po_box_deviating_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_city_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxDeviatingRegion($po_box_deviating_region)
    {
        ...
        if (!is_null($po_box_deviating_region) && (mb_strlen($po_box_deviating_region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_region when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPoBoxLobbyName($po_box_lobby_name)
    {
        ...
        if (!is_null($po_box_lobby_name) && (mb_strlen($po_box_lobby_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_lobby_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxPostalCode($po_box_postal_code)
    {
        ...
        if (!is_null($po_box_postal_code) && (mb_strlen($po_box_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box_postal_code when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRoomNumber($room_number)
    {
        ...
        if (!is_null($room_number) && (mb_strlen($room_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $room_number when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if (!is_null($street_name) && (mb_strlen($street_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 60.');
        }
    ...
    public function setStreetPrefixName($street_prefix_name)
    {
        ...
        if (!is_null($street_prefix_name) && (mb_strlen($street_prefix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetSuffixName($street_suffix_name)
    {
        ...
        if (!is_null($street_suffix_name) && (mb_strlen($street_suffix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name when calling APIOUTBOUNDDELIVERYSRVAOutbDeliveryAddress2TypeUpdate., must be smaller than or equal to 40.');
        }
