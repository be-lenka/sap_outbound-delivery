...
namespace BeLenka\SAP\OutboundDelivery;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://:/sap/opu/odata/sap/API_OUTBOUND_DELIVERY_SRV;v&#x3D;0002';
    ...
    {
        $report  = 'PHP SDK (BeLenka\SAP\OutboundDelivery) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://{host}:{port}/sap/opu/odata/sap/API_OUTBOUND_DELIVERY_SRV;v=0002",
            ...
            [
                "url" => "https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_OUTBOUND_DELIVERY_SRV;v=0002",
                "description" => "No description provided",
            ]
        ];
    }
