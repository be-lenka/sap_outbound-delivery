...
/**
 * OutboundDeliveryMaintenanceItemObjectListHeadersApi Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\OutboundDelivery
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OutboundDeliveryMaintenanceItemObjectListHeadersApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    public function aOutbDeliveryItemDeliveryDocumentDeliveryDocumentDeliveryDocumentItemDeliveryDocumentItemToSerialDeliveryItemGetRequest($delivery_document, $delivery_document_item, $select = null, $expand = null, string $contentType = self::contentTypes['aOutbDeliveryItemDeliveryDocumentDeliveryDocumentDeliveryDocumentItemDeliveryDocumentItemToSerialDeliveryItemGet'][0])
    {
        ...
        if (strlen($delivery_document) > 10) {
            throw new \InvalidArgumentException('invalid length for "$delivery_document" when calling OutboundDeliveryMaintenanceItemObjectListHeadersApi.aOutbDeliveryItemDeliveryDocumentDeliveryDocumentDeliveryDocumentItemDeliveryDocumentItemToSerialDeliveryItemGet, must be smaller than or equal to 10.');
        }
        ...
        if (strlen($delivery_document_item) > 6) {
            throw new \InvalidArgumentException('invalid length for "$delivery_document_item" when calling OutboundDeliveryMaintenanceItemObjectListHeadersApi.aOutbDeliveryItemDeliveryDocumentDeliveryDocumentDeliveryDocumentItemDeliveryDocumentItemToSerialDeliveryItemGet, must be smaller than or equal to 6.');
        }
